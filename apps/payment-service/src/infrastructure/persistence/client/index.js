...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "src/infrastructure/persistence/client",
...
path.join(process.cwd(), "src/infrastructure/persistence/client/libquery_engine-darwin.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/infrastructure/persistence/client/schema.prisma")
